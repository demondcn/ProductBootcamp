  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl flex w-full max-w-4xl overflow-hidden">
        ...
        >
          ...
          <div className="mt-24">
            ...
            <form onSubmit={isLogin ? handleSubmitLogin(onSubmitLogin) : handleSubmitRegister(onSubmitRegister)} className="space-y-4">
              ...
              <button className="w-full bg-yellow-500 text-white py-2 rounded-xl hover:bg-yellow-600 transition duration-300 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50">
        ...
        <motion.div
          className="w-1/2 bg-yellow-500 text-white rounded-tr-2xl rounded-br-2xl py-16 px-12 relative overflow-hidden"
          initial={{ x: isLogin ? 0 : '-100%' }}
          animate={{ x: isLogin ? 0 : '-100%' }}
          transition={{ duration: 0.6 }}
        >
          ...
          <p className="mb-10 relative z-10 text-lg">
            {isLogin
              ? 'Introduce tus datos personales y comienza tu camino hacia el bienestar integral.'
              : 'Mejora tu equilibrio emocional y bienestar. Regístrate hoy y aprovecha esta oportunidad para transformar tu vida holísticamente.'}
